...
export default function Sidebar() {
  ...
  const users = [
    {
      name: "Ubaid",
      message: "Hey Ubiad, How are you?",
      time: "12:40",
    },
    {
      name: "Shahzain Tariq",
      message: "Hey Shahzain, How are you?",
      time: "12:40",
    },
    {
      name: "Haider",
      message: "Hey Haider, How are you?",
      time: "12:40",
    },
    {
      name: "Shahzain Tariq",
    ...
    {
      name: "Usman Farooq",
      message: "Hey Usman Farooq, How are you?",
      time: "12:40",
    },
    {
      name: "Amna",
      message: "Hey Amna, How are you?",
      time: "12:40",
    },
    {
      name: "Shehraz bhai",
          ...
          return (
            ...
            >
              ...
              <div className="flex flex-col ml-2 w-full">
                ...
                <p className="text-[12px] text-[gray] mt-1">{user.message}</p>
              </div>
            </div>
          );
        })}
