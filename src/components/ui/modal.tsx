...
const modalOverlayStyles = tv({
  base: [
    "fixed top-0 left-0 isolate z-50 h-(--visual-viewport-height) w-full h-screen",
        ...
        <Dialog role={role}>
          {(values) => (
            <>
              ...
              {closeButton && <Dialog.CloseIndicator  close={values.close}  isDismissable={isDismissable} />}
            </>
          )}
        </Dialog>
      </ModalPrimitive>
